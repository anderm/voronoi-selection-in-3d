...
namespace csDelaunay {
	...
	public class Voronoi {
        ...
        private double weightDistributor;
		...
		public Voronoi(List<Vector2f> points, Rectf plotBounds, double weightDistributor) {
			this.weightDistributor = weightDistributor;
			Init(points,plotBounds);
		}

		public Voronoi(List<Vector2f> points, Rectf plotBounds, double weightDistributor, int lloydIterations) {
            this.weightDistributor = weightDistributor;
            Init(points,plotBounds);
